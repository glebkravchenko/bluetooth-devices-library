...
//    val TONOMETER_UUID_CHARACTER_RECEIVE_V1: UUID = UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb")
//    val TONOMETER_UUID_CHARACTER_RECEIVE_V2: UUID = UUID.fromString("0000fff2-0000-1000-8000-00805f9b34fb")
}
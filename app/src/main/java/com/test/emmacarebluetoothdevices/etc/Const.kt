...
//    val SCALES_DEVICE_ID: UUID
    val SCALES_UUID_SERVICE_DATA: UUID = UUID.fromString("0000FFF0-0000-1000-8000-00805f9b34fb")
    val SCALES_UUID_CHARACTER_RECEIVE: UUID = UUID.fromString("0000fff4-0000-1000-8000-00805f9b34fb")
    val SCALES_UUID_MODIFY_BT_NAME: UUID = UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb")
